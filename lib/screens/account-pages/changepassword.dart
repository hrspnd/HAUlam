      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            if (!passwordsMatch && newPasswordController.text.isNotEmpty)
              const Padding(
                padding: EdgeInsets.only(left: 8.0, bottom: 8.0),
                child: Text(
                  "Passwords do not match.",
                  style: TextStyle(color: Color(0xFF710E1D), fontSize: 12),
                ),
              ),

            _passwordChecklist(currentPasswordController.text),
